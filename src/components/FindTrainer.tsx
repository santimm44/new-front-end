        ...
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                type="text"
                className="w-full h-12 rounded-xl px-4 border-2 border-gray-200 focus:border-[#FC6F2F] focus:outline-none transition-colors bg-gradient-to-r from-[#FFE9D1] to-[#FFF2E6] text-gray-800 placeholder-gray-500"
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full rounded-xl px-4 py-3 border-2 border-gray-200 focus:border-[#FC6F2F] focus:outline-none transition-colors bg-gradient-to-r from-[#FFE9D1] to-[#FFF2E6] text-gray-800 placeholder-gray-500 resize-none h-24"
              />
            </div>
            ...
            <div className="flex gap-4 pt-4">
              ...
              <button
                ...
                className="flex-1 h-12 rounded-xl bg-gradient-to-r from-[#FC6F2F] to-[#FF8A65] text-white font-semibold hover:from-[#e25f20] hover:to-[#FF7043] transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
              >
                {loading ? (
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800">Trainer Matcher</h1>
            <p className="text-gray-600 mt-1">Find your perfect Trainer</p>
          </div>
          <button
            onClick={handleToggleSettings}
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#FC6F2F] to-[#FF8A65] text-white font-semibold rounded-xl hover:from-[#e25f20] hover:to-[#FF7043] transition-all shadow-lg"
          >
            <Edit3 size={18} />
            Edit Profile
          </button>
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button
                  onClick={handleNext}
                  className="flex-1 flex items-center justify-center gap-2 h-14 rounded-xl border-2 border-gray-300 text-gray-700 font-semibold hover:bg-gray-50 transition-colors"
                >
                  Next Profile
